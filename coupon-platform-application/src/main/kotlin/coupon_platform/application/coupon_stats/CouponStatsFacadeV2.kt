...
import coupon_platform.domain.issued_coupon.service.IssuedCouponReadServiceV2
import org.springframework.stereotype.Service
import java.time.LocalDate

@Service
class CouponStatsFacadeV2(
    private val issuedCouponReadServiceV2: IssuedCouponReadServiceV2,
    ...
    private fun calculateCouponDailyStats(emptyDates: List<LocalDate>): List<CouponDailyStatsInfo> {
        val issuedCoupons: List<IssuedCouponInfo> = issuedCouponReadServiceV2.findIssuedCouponsInDates(emptyDates) // 로컬 캐시 데이터 조회
